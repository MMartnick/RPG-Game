...
// create an object for holding the characters
			...
			var renderCharacter = function (character, renderArea) {
				...
				var charName = $("<div class = 'character-name'>").text(character);
				var charImage = $("<img alt = 'image' class='character-image'>").attr("src", character.imageUrl);
				var charHealth = $("<div class ='character-health'>").text(character.health);
				charDiv.append(charDiv).append(charImage).append(charHealth);
			...
			$("#characters-section").on("click", ".character", function () {
				...
				if (!attacker) {
					...
					updateCharacters(attacker, "#selected-character");
			...
			$("#attack-button").on("click", function () {
				...
				if ($("#defender").children().length !== 0) {
					...
					var counterAttackMessage = defender.name + " attacked you back for " + defender.enemyAttack;
					clearMessage()
